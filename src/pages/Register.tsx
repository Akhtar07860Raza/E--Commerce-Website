  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 shadow-sm">
        <div>
          <h2 className="mt-6 text-center text-3xl font-serif text-black">Create an account</h2>
          <p className="mt-2 text-center text-sm text-zinc-600">
            Already have an account?{' '}
            <Link to={`/login?redirect=${redirect}`} className="font-medium text-gold hover:text-black transition-colors">
              Sign in
            </Link>
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-3 border border-zinc-300 placeholder-zinc-500 text-black focus:outline-none focus:ring-gold focus:border-gold focus:z-10 sm:text-sm"
